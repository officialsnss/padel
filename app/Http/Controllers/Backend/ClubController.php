    ...
    public function popularStatus(Request $request)
      {
        ...
        public function resetPassword(Request $request, $id)
        {
           try{
                ...
                return view('backend.pages.clubs.resetPassword', compact('title', 'userEmail','userId'));
           }
           catch (\Exception $e) {
            dd($e->getMessage());
        ...
        public function newPassword(Request $request, $id)
        {
              ...
              try{
                ...
                return redirect('/admin/users/court-owners')->with('success', 'Password reset successfully');
            }
            catch (\Exception $e) {
                return redirect('/admin/users/court-owners')->with('error', 'Something went wrong.');
             }
