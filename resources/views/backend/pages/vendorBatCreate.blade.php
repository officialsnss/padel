    ...
    <div class="row">
       <div class="col-md-12">
          <div class="card card-primary">
            ...
            <div class="card-body">
         <form method="post" action="{{ route('vendor.add') }}" id="vendorcreateform" enctype="multipart/form-data">
            {{ csrf_field() }}
          <div class="row">
            <div class="col-md-12"> 
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" id="quantity" class="form-control" value="" name="quantity">
                     @error('quantity')
                      <div class="form-error">{{ $message }}</div>
                      @enderror
                </div>
