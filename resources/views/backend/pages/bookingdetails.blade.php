    ...
    <div class="card">
        ...
        <div class="card-body">
                        ...
                        <tr>
                            <td>
                                @if ($bookingInfo->payment_status == '1')
                                    <img src="{{asset('Images/icons/paid.png')}}" width="150px" alt="paid-icon">
                                @else
                                <img src="{{asset('Images/icons/cross.png')}}" width="150px" alt="cross-icon">
                                @endif
                            </td>
                        </tr>
                    </table>
            ...
            <div class="row">
                <div class="bk-btn">
                    @if ($bookingInfo->payment_status == '1')
                        <a href="{{ url('admin/generate-invoice-pdf') }}/{{ $bookingInfo->bookingid }}" onclick="#"
