        ...
        <nav class="navbar navbar-expand-lg bg-light">
            <div class="container">
                <button class="btn btn-danger navbar-toggler border-3 px-2" type="button" data-bs-toggle="offcanvas"
                    data-bs-target="#offcanvasExample" aria-controls="offcanvasExample"><img style="width: 30px"
                        src="{{ asset('frontend/images/text-center.svg') }}" alt="menu icon"></button>

                <div class="offcanvas offcanvas-start-lg bg-dark" tabindex="-1" id="offcanvasExample"
                    aria-labelledby="offcanvasExampleLabel">
                    <div class="offcanvas-header d-flex d-lg-none">
                        <h5 class="offcanvas-title text-white" id="offcanvasExampleLabel"><img
                                src="{{ asset('frontend/images/logo-white.svg') }}" alt="" class="img-fluid"></h5>
